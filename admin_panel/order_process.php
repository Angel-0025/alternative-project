...
print_r($product['customer_fname']);
?>
<div class="content">
    <!-- Order History -->
    <div class="row">
        ...
        <!-- Order History -->
            <div class="card card-table-border-none" id="recent-orders">
                <div class="card-header justify-content-between">
                    <h2>Order ID Number: <?=$product['ref_num']?> </h2>
                </div>
                <div class="card-body pt-0 pb-5">
                    <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php }?>
                                <td class="d-none d-md-table-cell"><a href="index.php?page=product_detail&id=<?=$product['product_id']?>"><?=$product['name']?></td>
                                <?php }?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8">
                            ...
                            <select class="form-control form-control-md input-md" id="process_status">
                        ...
                        <div class="col-sm-4 mt-4 pt-3">
                            ...
                            <a class="mb-1 btn btn-success btn-sm"  href="index.php?page=order_process&id=">Update Process</a>
