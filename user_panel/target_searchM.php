                ...
                <div class="row shop_container list">
                    <div class="col-lg-3 col-md-4 col-6">
                        ...
                        // get the search terms from the url
                            ...
                            $search_string = "SELECT * FROM product WHERE user_target LIKE '{$k}'";
                        ...
                        <?php }
                            ...
                            <h3 style="text-align: center;"><?php echo ucwords($_GET['catrftm']);?> doesn't exist</h3>
                        <?php }?>
                    </div>
